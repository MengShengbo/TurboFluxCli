...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| fastcontext | 5 / 5 | 100.0% | 0.561 [0.179, 0.943] | 0.629 [0.229, 1.000] | 0.518 | 0.566 | 40.0% | 73.3s / 80.5s | 38.2 | 7216 / 3619 |
...
| System | Tasks / runs | Success | R@10 (95% CI) | MRR (95% CI) | MAP | nDCG@10 | Full@10 | p50 / p95 | Tools | Tokens in/out |
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| fastcontext | 3 / 3 | 100.0% | 0.268 [0.000, 0.714] | 0.381 [0.000, 1.000] | 0.197 | 0.276 | 0.0% | 73.3s / 80.5s | 38.0 | 6856 / 3327 |

### swebench-verified

| System | Tasks / runs | Success | R@10 (95% CI) | MRR (95% CI) | MAP | nDCG@10 | Full@10 | p50 / p95 | Tools | Tokens in/out |
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| fastcontext | 2 / 2 | 100.0% | 1.000 [1.000, 1.000] | 1.000 [1.000, 1.000] | 1.000 | 1.000 | 100.0% | 62.5s / 76.5s | 38.5 | 7756 / 4057 |

## Language Slices

| Language | System | N | Success | R@10 | MRR | p50 |
|---|---|---:|---:|---:|---:|---:|
| Java | fastcontext | 1 | 100.0% | 0.000 | 0.000 | 80.5s |
| JavaScript | fastcontext | 1 | 100.0% | 0.714 | 1.000 | 69.2s |
| Python | fastcontext | 2 | 100.0% | 1.000 | 1.000 | 62.5s |
| TypeScript | fastcontext | 1 | 100.0% | 0.091 | 0.143 | 73.3s |
