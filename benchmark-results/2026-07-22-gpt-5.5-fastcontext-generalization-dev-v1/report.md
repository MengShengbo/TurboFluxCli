...
- Completed runs: 18/24
- Dataset cases: 24; repositories: 16; languages: Java, JavaScript, Python, TypeScript
- Repository snapshots processed: 0.04M files, 0.30 GiB (counts include repeated base commits)
- Per-run timeout: 300s; repeats: 1; seed: 20260722
- Manifest SHA-256: `06b62b219933f8c23e7ce4664c571105e9925b8bf57b52748d89211386a5b90d`
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| fastcontext-medium | 18 / 18 | 100.0% | 0.852 [0.736, 0.949] | 0.972 [0.917, 1.000] | 0.820 | 0.869 | 66.7% | 85.4s / 218.1s | 19.9 | 86562 / 3625 |
...
| System | Tasks / runs | Success | R@10 (95% CI) | MRR (95% CI) | MAP | nDCG@10 | Full@10 | p50 / p95 | Tools | Tokens in/out |
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| fastcontext-medium | 12 / 12 | 100.0% | 0.896 [0.750, 1.000] | 1.000 [1.000, 1.000] | 0.896 | 0.917 | 83.3% | 83.4s / 103.3s | 18.8 | 72225 / 3441 |

### swepolybench-verified

| System | Tasks / runs | Success | R@10 (95% CI) | MRR (95% CI) | MAP | nDCG@10 | Full@10 | p50 / p95 | Tools | Tokens in/out |
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| fastcontext-medium | 6 / 6 | 100.0% | 0.764 [0.625, 0.903] | 0.917 [0.750, 1.000] | 0.669 | 0.772 | 33.3% | 106.5s / 218.1s | 22.0 | 115236 / 3993 |

## Language Slices

| Language | System | N | Success | R@10 | MRR | p50 |
|---|---|---:|---:|---:|---:|---:|
| Java | fastcontext-medium | 3 | 100.0% | 0.917 | 1.000 | 116.3s |
| JavaScript | fastcontext-medium | 3 | 100.0% | 0.611 | 0.833 | 103.0s |
| Python | fastcontext-medium | 12 | 100.0% | 0.896 | 1.000 | 83.4s |
| TypeScript | fastcontext-medium | 0 | 0.0% | 0.000 | 0.000 | 0.0s |
