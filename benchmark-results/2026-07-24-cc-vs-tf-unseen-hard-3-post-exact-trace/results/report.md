...
- Completed runs: 6/6
- Dataset cases: 3; repositories: 3; languages: JavaScript, Python
- Repository snapshots processed: 0.01M files, 0.01 GiB (counts include repeated base commits)
- Per-run timeout: 300s; repeats: 1; seed: 20260722
- Manifest SHA-256: `d1c684aa7bcc0a2451bbb779f474b8b79275b0d7d16f58925b8a88e7b2c57b3c`
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| fastcontext | 3 / 3 | 100.0% | 0.917 [0.750, 1.000] | 1.000 [1.000, 1.000] | 0.840 | 0.908 | 66.7% | 114.9s / 152.4s | 57.0 | 15687 / 4903 |
| claude-code-readonly | 3 / 3 | 100.0% | 0.917 [0.750, 1.000] | 1.000 [1.000, 1.000] | 0.896 | 0.935 | 66.7% | 174.4s / 210.1s | 12.0 | 33944 / 1989 |
...
| System | Tasks / runs | Success | R@10 (95% CI) | MRR (95% CI) | MAP | nDCG@10 | Full@10 | p50 / p95 | Tools | Tokens in/out |
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| fastcontext | 2 / 2 | 100.0% | 1.000 [1.000, 1.000] | 1.000 [1.000, 1.000] | 0.917 | 0.960 | 100.0% | 114.9s / 152.4s | 58.0 | 18619 / 5658 |
| claude-code-readonly | 2 / 2 | 100.0% | 1.000 [1.000, 1.000] | 1.000 [1.000, 1.000] | 1.000 | 1.000 | 100.0% | 99.6s / 210.1s | 13.0 | 33636 / 2058 |

### swebench-verified

| System | Tasks / runs | Success | R@10 (95% CI) | MRR (95% CI) | MAP | nDCG@10 | Full@10 | p50 / p95 | Tools | Tokens in/out |
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| fastcontext | 1 / 1 | 100.0% | 0.750 [0.750, 0.750] | 1.000 [1.000, 1.000] | 0.688 | 0.805 | 0.0% | 78.3s / 78.3s | 55.0 | 9824 / 3393 |
| claude-code-readonly | 1 / 1 | 100.0% | 0.750 [0.750, 0.750] | 1.000 [1.000, 1.000] | 0.688 | 0.805 | 0.0% | 174.4s / 174.4s | 10.0 | 34561 / 1851 |

## Language Slices

| Language | System | N | Success | R@10 | MRR | p50 |
|---|---|---:|---:|---:|---:|---:|
| JavaScript | fastcontext | 2 | 100.0% | 1.000 | 1.000 | 114.9s |
| JavaScript | claude-code-readonly | 2 | 100.0% | 1.000 | 1.000 | 99.6s |
| Python | fastcontext | 1 | 100.0% | 0.750 | 1.000 | 78.3s |
| Python | claude-code-readonly | 1 | 100.0% | 0.750 | 1.000 | 174.4s |

## Paired Tests

| FastContext system | Comparator | Pairs | Mean R@10 difference | Paired permutation p |
|---|---|---:|---:|---:|
| fastcontext | claude-code-readonly | 3 | 0.000 | 1.0000 |
