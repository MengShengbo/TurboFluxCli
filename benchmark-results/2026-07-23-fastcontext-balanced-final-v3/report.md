...
- Completed runs: 6/6
- Dataset cases: 6; repositories: 6; languages: Python
- Repository snapshots processed: 0.01M files, 0.14 GiB (counts include repeated base commits)
- Per-run timeout: 180s; repeats: 1; seed: 20260722
- Manifest SHA-256: `bebf555ab4b5ec6e98611d2f52308f25dcaa544d74e9285debe6de005775c547`
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| fastcontext | 6 / 6 | 100.0% | 1.000 [1.000, 1.000] | 0.783 [0.517, 1.000] | 0.797 | 0.847 | 100.0% | 21.9s / 108.9s | 53.3 | 16654 / 1703 |
...
|---|---|---:|---:|---:|---:|---:|
| Python | fastcontext | 6 | 100.0% | 1.000 | 0.783 | 21.9s |
