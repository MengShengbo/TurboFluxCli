...
- Repository snapshots processed: 0.01M files, 0.04 GiB (counts include repeated base commits)
- Per-run timeout: 300s; repeats: 1; seed: 20260722
- Manifest SHA-256: `51dd1e96d8689abf61944fbcd1e77e6a3370c710bdf8e4396f83982134cafa4b`
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| fastcontext | 3 / 3 | 100.0% | 1.000 [1.000, 1.000] | 0.833 [0.500, 1.000] | 0.833 | 0.877 | 100.0% | 54.1s / 55.7s | 36.7 | 6665 / 2613 |
...
| System | Tasks / runs | Success | R@10 (95% CI) | MRR (95% CI) | MAP | nDCG@10 | Full@10 | p50 / p95 | Tools | Tokens in/out |
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| fastcontext | 2 / 2 | 100.0% | 1.000 [1.000, 1.000] | 0.750 [0.500, 1.000] | 0.750 | 0.815 | 100.0% | 44.5s / 55.7s | 37.5 | 6495 / 2522 |

### swepolybench-verified

| System | Tasks / runs | Success | R@10 (95% CI) | MRR (95% CI) | MAP | nDCG@10 | Full@10 | p50 / p95 | Tools | Tokens in/out |
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| fastcontext | 1 / 1 | 100.0% | 1.000 [1.000, 1.000] | 1.000 [1.000, 1.000] | 1.000 | 1.000 | 100.0% | 54.1s / 54.1s | 35.0 | 7007 / 2796 |

## Language Slices

| Language | System | N | Success | R@10 | MRR | p50 |
|---|---|---:|---:|---:|---:|---:|
| JavaScript | fastcontext | 1 | 100.0% | 1.000 | 1.000 | 54.1s |
| Python | fastcontext | 2 | 100.0% | 1.000 | 0.750 | 44.5s |
